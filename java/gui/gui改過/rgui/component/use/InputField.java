    ...
    public InputField(String text) {
        ...
        this.addRenderListener(new RenderListener(){
            ...
            public void onPostRender() {
                ...
                GL11.glEnable(3089);
                GL11.glTranslatef((-InputField.this.scrollX), 0.0f, 0.0f);
                FontRenderer fontRenderer = InputField.this.getFontRenderer();
                GL11.glLineWidth(1.0f);
                GL11.glColor3f(1.0f, 1.0f, 1.0f);
                boolean cursor = ((System.currentTimeMillis() - InputField.this.lastTypeMS) / 500L) % 2 == 0 && InputField.this.isFocussed();
                int x = 0;
                int i = 0;
