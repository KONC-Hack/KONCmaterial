package kotori.koncclient.konc.gui.rgui.util;
...
public class ContainerHelper {
    ...
    public static <S extends Component> List<Component> getAllChildren(Class<? extends S> childClass, Container parent) {
