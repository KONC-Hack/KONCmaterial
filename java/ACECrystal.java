...
import kotori.koncclient.konc.util.BlockInteractionHelper;
   ...
   public void onWorldRender(RenderEvent event) {
      if (render != null) {
         ...
         if (renderMode.getValue() == 1) {
            KamiTessellator.drawBox(render, espR.getValue(), espG.getValue(), espB.getValue(), espA.getValue(), 2);
         }

         if (renderMode.getValue() == 2) {
            KamiTessellator.drawBox(render, espR.getValue(), espG.getValue(), espB.getValue(), espA.getValue(), 63);
         }

         if (renderMode.getValue() == 3) {
            KamiTessellator.drawBox(render, espR.getValue(), espG.getValue(), espB.getValue(), espA.getValue(), 1);
         }
