package kotori.koncclient.konc.module.modules.combat;
...
import kotori.koncclient.konc.util.MathUtil;
...
public class AutoCrystal extends Module {
    ...
    private Setting<Boolean> AutoCrystalPVPInfo = register(Settings.booleanBuilder("AutoCrystalPVPInfo").withValue(false).withVisibility(b -> general.getValue()).build());
