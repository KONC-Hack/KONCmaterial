...
import kotori.koncclient.konc.gui.rgui.layout.UselessLayout;
...
extends OrganisedContainer {
    ...
    public void setBox(boolean boxToggle) {
        this.boxEnabled = boxToggle;
    }

    public void setTitleEnabled(boolean titleToggle) {
        this.titleEnabled = titleToggle;
    }
    ...
    public void displayPinButton(boolean displayPin) {
        this.isPinDisplayed = displayPin;
    }
    ...
    public static abstract class FrameDragPoof<T extends Frame, S extends FrameDragPoof.DragInfo>
    extends Poof<T, S> {
    ...
    implements MouseListener {
        ...
        public void onMouseDown(MouseListener.MouseButtonEvent event) {
            ...
            boolean bl = Frame.this.doDrag = Frame.this.dy <= Frame.this.getOriginOffsetY() && event.getButton() == 0 && Frame.this.dy > 0;
