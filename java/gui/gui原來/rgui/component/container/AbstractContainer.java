...
import kotori.koncclient.konc.gui.rgui.poof.use.AdditionPoof;
...
public abstract class AbstractContainer extends AbstractComponent implements Container
{
    ...
    public abstract void setBox(Boolean value);

    protected abstract void displayPinButton(boolean b);

    protected abstract void setTitleEnabled(boolean b);
}
