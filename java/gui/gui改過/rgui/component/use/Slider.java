...
extends AbstractComponent {
    ...
    private double calculateValue(double x) {
        ...
        return MathHelper.clamp(Math.floor((double)Math.round(s / this.step) * this.step * 100.0) / 100.0, this.minimum, this.maximum);
    }
    ...
    public static abstract class SliderPoof<T extends Component, S extends SliderPoof.SliderPoofInfo>
    extends Poof<T, S> {
